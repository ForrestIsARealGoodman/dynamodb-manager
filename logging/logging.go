...
func NewLogger(level ...string) (*Logger, error) {
	...
	if os.Getenv("GIN_MODE") == "release" {
		...
		lConfig.InitialFields = map[string]interface{}{"podName": hostname}
	} else {
