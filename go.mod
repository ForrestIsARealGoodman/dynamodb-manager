...
require (
	github.com/ForrestIsARealGoodman/dynamodb-manager/client v0.0.0-20240221103134-ced37a4ed284
	github.com/ForrestIsARealGoodman/dynamodb-manager/search v0.0.0-20240221103405-029db2ceb613
	github.com/ForrestIsARealGoodman/dynamodb-manager/update v0.0.0-20240221103405-029db2ceb613
