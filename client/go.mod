module github.com/ForrestIsARealGoodman/dynamodb-manager/client

go 1.20

require (
	github.com/ForrestIsARealGoodman/dynamodb-manager/logging v0.0.0-20240221110741-558121082fe7
